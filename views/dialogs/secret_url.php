...
<div class="ccm-ui">
    ...
    <table class="table table-striped" id="ccm-secret-url-table">
        ...
        foreach ($signatures as $signature) {
            $viewUrl = $resolver->resolve(['/ccm/secret_url', 'view', $signature->getSignatureString()]);
            $deleteUrl = $resolver->resolve(['/ccm/secret_url', 'dialog/delete', $signature->getSignatureString()]);
